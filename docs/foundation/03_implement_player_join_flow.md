...
- **Player Creation (`players#create` action):**
  ...
  - After the player is created, they should be redirected to their hand lobby screen.

## Acceptance Criteria
- A user can navigate to a join URL (either by creating a room or entering a code).
...
- After joining, the user is redirected to their hand lobby screen.
