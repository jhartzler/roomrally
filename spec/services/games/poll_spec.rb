...
RSpec.describe Games::Poll do
  ...
  describe ".close_round — majority mode" do
    ...
    it "awards no points on perfect tie" do
      ...
      described_class.start_question(game: game2)
      p1, p2 = players[0..1]
      described_class.submit_answer(game: game2, player: p1, selected_option: "dogs")
      described_class.submit_answer(game: game2, player: p2, selected_option: "cats")
      described_class.close_round(game: game2)
